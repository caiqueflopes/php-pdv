	...
	if($_POST){
		...
		if($user->emailExists()){
			echo "<div class='alert alert-danger'>";
				echo "O e-mail informado já está registrado. Faça o <a href='{$home_url}login'>login.</a>";
			echo "</div>";
		}
			...
			if($user->create()){
				...
				echo "<div class='alert alert-info'>";
					echo "Cadastrado com sucesso! <a href='{$home_url}login'>Faça o Login</a>.";
				echo "</div>";
				...
				echo "<div class='alert alert-danger' role='alert'>Ops!. Algo deu errado tente novamente.</div>";
			}
		}
	}
?>
